...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row mt-3">
        ...
        <div class="col-sm-12">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ErrorMessage="Título é obrigatório!" ControlToValidate="txtTitle"></asp:RequiredFieldValidator>
        </div>
        <div class="col-sm-12">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Texto é obrigatório!" ControlToValidate="txtText"></asp:RequiredFieldValidator>
        </div>
